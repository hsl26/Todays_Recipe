...
def display_mypage():
    ...
    with cols[0]:
        ...
        with st.form("add_likes", clear_on_submit=True):
            st.markdown("**선호 메뉴/재료 추가하기**")
            add_likes_input = st.text_input("추가할 메뉴/재료 입력하세요. 예시) 사과", value="")
        ...
        with st.form("del_likes", clear_on_submit=True):
            st.markdown("**선호 메뉴/재료 삭제하기**")
            delete_likes_input = st.text_input("삭제할 메뉴/재료 입력하세요. 예시) 사과", value="")
    ...
    with cols[1]:
        ...
        with st.form("add_dislikes", clear_on_submit=True):
            st.markdown("**비선호 메뉴/재료 추가하기**")
            add_dislikes_input = st.text_input("추가할 메뉴/재료 입력하세요. 예시) 사과", value="")
        ...
        with st.form("del_dislikes", clear_on_submit=True):
            st.markdown("**비선호 메뉴/재료 삭제하기**")
            delete_dislikes_input = st.text_input("삭제할 메뉴/재료 입력하세요. 예시) 사과", value="")
